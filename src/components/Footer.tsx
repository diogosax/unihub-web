...
const navColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Inglês UniHub", href: "/carreiras" },
...
export default function Footer() {
  return (
    <footer className="w-full bg-dark text-gray-400">
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          ...
          <p className="text-sm leading-relaxed mb-5">
            Educação Corporativa Interativa. Transformando empresas através do conhecimento.
          </p>
          {/* LinkedIn */}
          <a
      ...
      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-xs text-gray-600">made with ❤️ in Tampa</p>
        </div>
      </div>
    </footer>
  );
